...
- **Giorgia Carboni** — camera, PDB parser, bond detection, sphere and cylinder impostors (CPU geometry + shaders), tight NDC bounding box, ground plane, shadows' anti-aliasing correction, silhouette/crease-line pass, composite pass, ImGui panel, benchmark infrastructure 
